...
from rwa_calculator.fastapi_app import create_app
...
class FastApiMicroserviceTests(unittest.TestCase):
    ...
    def test_health_reports_scipy_backend(self) -> None:
        ...
        self.assertEqual(response.json()["reference_data_package_id"], "rwa_regulatory_reference_seed")
    ...
    def test_json_calculation_endpoint_validates_and_calculates(self) -> None:
        with open("preprod_core_info_1000.csv", newline="", encoding="utf-8") as handle:
    ...
    def test_csv_calculation_endpoint_uses_batch_validation(self) -> None:
        with open("preprod_core_info_1000.csv", "rb") as core:
            response = self.client.post(
                "/rwa/calculate/csv",
