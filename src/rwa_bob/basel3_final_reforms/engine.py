...
class RwaEngine:
    ...
    def calculate(self, request: RwaCalculationRequest) -> RwaCalculationResponse:
        ...
        success_results, error_results = self.calculator.calculate_portfolio_rwa(
            request.core_info, request.country_info
        )
        ...
        return RwaCalculationResponse(
            success_records=success_records, errors=errors, summary=summary
        )
    ...
    def calculate_with_trace(
        ...
        """
        success_results, error_results = self.calculator.calculate_portfolio_rwa(
            core_info_list, country_info_list
        )
        ...
        return {
            ...
            "summary": {
                ...
                "total_rwa_basel_3_0": sum(r["basel_3_0_rwa"] for r in success_results),
                "total_rwa_basel_3_1": sum(r["basel_3_1_rwa_final"] for r in success_results),
            },
        }
