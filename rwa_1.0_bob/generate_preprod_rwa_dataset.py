...
def build_core_rows(nccr_mapping: dict[str, dict[str, Decimal]]) -> list[dict[str, str]]:
    ...
    for idx in range(1, ROW_COUNT + 1):
        ...
        row = {
            ...
            "govt_guarantee_flag": "Y" if entity in {EntityClass.SOV, EntityClass.PSE, EntityClass.MDB} or rng.random() < 0.07 else "N",
            ...
            "counterparty_credit_quality_grade": credit_quality_for_rating(fcy_rating, external_rating or None),
        }
